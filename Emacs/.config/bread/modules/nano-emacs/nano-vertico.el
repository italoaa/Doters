...
(defun nano-vertico--setup ()
  ...
  (face-remap-reset-base 'header-line 'nano-vertico-header-face)
  (face-remap-reset-base 'mode-line 'nano-vertico-mode-line-face)
  (face-remap-reset-base 'mode-line-inactive 'nano-vertico-mode-line-face)
  (face-remap-reset-base 'region 'default)
  (face-remap-reset-base 'default 'nano-vertico-buffer-face)
