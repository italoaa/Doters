;;; spacegrey-dark.el -*- lexical-binding: t; -*-
;;
...
;; Modified: February 06, 2022
;; Version: 0.0.1
;; Keywords: abbrev bib c calendar comm convenience data docs emulations extensions faces files frames games hardware help hypermedia i18n internal languages lisp local maint mail matching mouse multimedia news outlines processes terminals tex tools unix vc wp
;; Homepage: https://github.com/italo/spacegrey-dark
...
;;
;;; Code:
;;; doom-spacegrey-dark-theme.el --- inspired by Atom Spacegrey Dark -*- lexical-binding: t; no-byte-compile: t; -*-
(deftheme spacegrey-dark)

(require 'doom-themes)

(defgroup doom-spacegrey-dark-theme nil
  "Options for the `doom-spacegrey' theme."
  :group 'doom-themes)

(defcustom doom-spacegrey-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-spacegrey-dark-theme
  :type 'boolean)
...
;;; doom-spacegrey-dark-theme.el ends here


(provide-theme 'spacegrey-dark)
;;; spacegrey-dark.el ends here
