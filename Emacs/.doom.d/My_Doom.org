...
(setq doom-theme 'doom-rouge
      ...
      doom-font (font-spec :family "GohuMono" :size 16 :height 181 :weight 'light)
...
#+RESULTS:
| doom--setq-evil-normal-state-cursor-for-+doom-dashboard-mode-h | doom-modeline-set-project-modeline | (lambda (&rest _) (hide-mode-line-mode 1) (hl-line-mode -1)) |
